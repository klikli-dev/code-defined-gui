...
public final class FilterTranslationKeys {
    private FilterTranslationKeys() {
    }
    ...
    public static final class Button {
        private static final String PREFIX = FilterTranslationKeys.PREFIX + "button.";
    ...
    public static final class List {
        private static final String PREFIX = FilterTranslationKeys.PREFIX + "list.";
    ...
    public static final class Attribute {
        private static final String PREFIX = FilterTranslationKeys.PREFIX + "attribute.";
        private static final String SUMMARY_PREFIX = PREFIX + "summary.";
